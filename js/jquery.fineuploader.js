...
qq.Templating = function(spec) {
    ...
    var FILE_ID_ATTR = "qq-file-id",
        ...
        selectorClasses = {
            ...
            clear: "qq-upload-clear-selector",
    ...
    function getClear(id) {
        return getTemplateEl(getFile(id), selectorClasses.clear);
    }
    ...
    qq.extend(this, {
        ...
        updateProgress: function(id, loaded, total) {
            ...
            if (bar) {
                ...
                //bar.width(percent + "%");
                //bar.prop('aria-valuenow', percent);
        ...
        showClear: function(id) {
            if (!isCancelDisabled) {
                var clear = getClear(id);

                clear && qq(clear).removeClass(options.classes.hide);
            }
        },
